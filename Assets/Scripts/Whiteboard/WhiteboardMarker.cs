...
public class WhiteboardMarker : MonoBehaviour
{
    ...
    void Update()
    {
        // Hands are not initialized immediately, so we need to wait until they appear and are initialized.
        ...
        /* Since we're going to be using our index finger as the pen for this whiteboard, we need to cast a ray from the second joint of our index finger to the tip of the finger. */
        ...
        // Cast a ray starting from the second index finger joint to the tip of the index finger. Only check for objects that are in the whiteboard layer.
        if (Physics.Raycast(originPoint, direction, out touch, distance, 1 << WHITEBOARD_LAYER))
        {
            ...
            /* touch.textureCoord gives us the texture coordinates at which our raycast intersected the whiteboard. We can use this to tell the whiteboard where to render the next circle. */
        ...
        // If your thumb touches your index finger, clear the board.
